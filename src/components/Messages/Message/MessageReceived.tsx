  ...
  <div className="col-8 p-2 mt-1 mb-1">
    <div className="d-flex justify-content-left">
      <img
        ...
        alt=""
        className="img-thumbnail-small mr-3"
      />
      <div className="message received rounded-bottom rounded-right">
        <div className="d-flex justify-content-between">
          <p className="text-unimp m-2 message-name">James Bond</p>
          <p className="text-unimp m-2 time">12:32PM</p>
        </div>
        <p className="text-imp m-2">
          There is a big message right here for you test test test There is a
          big message right here for you test test test test
        </p>
      </div>
    </div>
  </div>
