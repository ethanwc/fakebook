  ...
  return (
    <div className="h-100 d-flex flex-column">
      <div className="profile m-2">
        ...
        />
        <h2 className="text-center p-0 m-0">James Bond</h2>
        <h5 className="text-center text-unimp">@jb123</h5>

        <div className="row">
          <div className="col-5 offset-1">
            <h5 className="text-center">1111</h5>
          </div>
          <div className="col-5">
            <h5 className="text-center">1111</h5>
          </div>
          <div className="col-5 offset-1">
            <h5 className="text-center text-unimp">Friends</h5>
          </div>
          <div className="col-5">
            <h5 className="text-center text-unimp">Posts</h5>
          </div>
          <div className="col-5 offset-1">
            <h5 className="text-center">1111</h5>
          </div>
          ...
          <div className="col-5">
            <h5 className="text-center text-unimp">Comments</h5>
          </div>
        </div>

        <h2 className="text-center">About</h2>
        <p className="text-center  text-unimp">
          I am an about about an about. awd awd wa
        </p>
      </div>
    </div>
  );
