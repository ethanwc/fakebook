...
const Content = (props: any) => {
  ...
  console.log(props);
  console.log(props.profileInfo[0].imageurl);
  const contactImage = !(
    props.profileInfo[0].imageurl !== undefined &&
    props.profileInfo[0].imageurl.length > 1
  ) ? (
    <img
    ...
    <img
      src={props.profileInfo[0].imageurl}
      alt=""
      className="img-thumbnail-small m-2"
    />
  );
      ...
      <div className="col-12">
        <div className="new-post m-2 mt-3 rounded pt-3">
          <div className="d-flex align-items-center ml-3 mr-3">
            <div onClick={redirectToProfile}>{contactImage}</div>
            <textarea
